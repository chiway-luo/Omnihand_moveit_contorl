...
omnihand_node_msgs__msg__TemperatureReport__init(omnihand_node_msgs__msg__TemperatureReport * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    omnihand_node_msgs__msg__TemperatureReport__fini(msg);
    return false;
  }
  // temperature_reports
  if (!rosidl_runtime_c__uint16__Sequence__init(&msg->temperature_reports, 0)) {
    omnihand_node_msgs__msg__TemperatureReport__fini(msg);
    return false;
  }
  return true;
...
omnihand_node_msgs__msg__TemperatureReport__fini(omnihand_node_msgs__msg__TemperatureReport * msg)
{
  ...
  // temperature_reports
  rosidl_runtime_c__uint16__Sequence__fini(&msg->temperature_reports);
}
...
omnihand_node_msgs__msg__TemperatureReport__are_equal(const omnihand_node_msgs__msg__TemperatureReport * lhs, const omnihand_node_msgs__msg__TemperatureReport * rhs)
{
  ...
  if (!rosidl_runtime_c__uint16__Sequence__are_equal(
      &(lhs->temperature_reports), &(rhs->temperature_reports)))
  {
    return false;
  }
  return true;
  ...
  omnihand_node_msgs__msg__TemperatureReport * output)
{
  ...
  if (!rosidl_runtime_c__uint16__Sequence__copy(
      &(input->temperature_reports), &(output->temperature_reports)))
  {
    return false;
  }
  return true;
...
omnihand_node_msgs__msg__TemperatureReport__create()
{
  ...
  omnihand_node_msgs__msg__TemperatureReport * msg = (omnihand_node_msgs__msg__TemperatureReport *)allocator.allocate(sizeof(omnihand_node_msgs__msg__TemperatureReport), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(omnihand_node_msgs__msg__TemperatureReport));
  bool success = omnihand_node_msgs__msg__TemperatureReport__init(msg);
  if (!success) {
...
omnihand_node_msgs__msg__TemperatureReport__Sequence__init(omnihand_node_msgs__msg__TemperatureReport__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  omnihand_node_msgs__msg__TemperatureReport * data = NULL;

  if (size) {
    data = (omnihand_node_msgs__msg__TemperatureReport *)allocator.zero_allocate(size, sizeof(omnihand_node_msgs__msg__TemperatureReport), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = omnihand_node_msgs__msg__TemperatureReport__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        omnihand_node_msgs__msg__TemperatureReport__fini(&data[i - 1]);
      }
...
omnihand_node_msgs__msg__TemperatureReport__Sequence__fini(omnihand_node_msgs__msg__TemperatureReport__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      omnihand_node_msgs__msg__TemperatureReport__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  omnihand_node_msgs__msg__TemperatureReport__Sequence * array = (omnihand_node_msgs__msg__TemperatureReport__Sequence *)allocator.allocate(sizeof(omnihand_node_msgs__msg__TemperatureReport__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = omnihand_node_msgs__msg__TemperatureReport__Sequence__init(array, size);
  if (!success) {
...
omnihand_node_msgs__msg__TemperatureReport__Sequence__destroy(omnihand_node_msgs__msg__TemperatureReport__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    omnihand_node_msgs__msg__TemperatureReport__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
omnihand_node_msgs__msg__TemperatureReport__Sequence__are_equal(const omnihand_node_msgs__msg__TemperatureReport__Sequence * lhs, const omnihand_node_msgs__msg__TemperatureReport__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!omnihand_node_msgs__msg__TemperatureReport__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  omnihand_node_msgs__msg__TemperatureReport__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(omnihand_node_msgs__msg__TemperatureReport);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    omnihand_node_msgs__msg__TemperatureReport * data =
      (omnihand_node_msgs__msg__TemperatureReport *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!omnihand_node_msgs__msg__TemperatureReport__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          omnihand_node_msgs__msg__TemperatureReport__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!omnihand_node_msgs__msg__TemperatureReport__copy(
