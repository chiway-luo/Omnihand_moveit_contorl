...
omnihand_node_msgs__msg__CurrentThreshold__init(omnihand_node_msgs__msg__CurrentThreshold * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    omnihand_node_msgs__msg__CurrentThreshold__fini(msg);
    return false;
  }
  // current_thresholds
  if (!rosidl_runtime_c__int16__Sequence__init(&msg->current_thresholds, 0)) {
    omnihand_node_msgs__msg__CurrentThreshold__fini(msg);
    return false;
  }
  return true;
...
omnihand_node_msgs__msg__CurrentThreshold__fini(omnihand_node_msgs__msg__CurrentThreshold * msg)
{
  ...
  // current_thresholds
  rosidl_runtime_c__int16__Sequence__fini(&msg->current_thresholds);
}
...
omnihand_node_msgs__msg__CurrentThreshold__are_equal(const omnihand_node_msgs__msg__CurrentThreshold * lhs, const omnihand_node_msgs__msg__CurrentThreshold * rhs)
{
  ...
  if (!rosidl_runtime_c__int16__Sequence__are_equal(
      &(lhs->current_thresholds), &(rhs->current_thresholds)))
  {
    return false;
  }
  return true;
  ...
  omnihand_node_msgs__msg__CurrentThreshold * output)
{
  ...
  if (!rosidl_runtime_c__int16__Sequence__copy(
      &(input->current_thresholds), &(output->current_thresholds)))
  {
    return false;
  }
  return true;
...
omnihand_node_msgs__msg__CurrentThreshold__create()
{
  ...
  omnihand_node_msgs__msg__CurrentThreshold * msg = (omnihand_node_msgs__msg__CurrentThreshold *)allocator.allocate(sizeof(omnihand_node_msgs__msg__CurrentThreshold), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(omnihand_node_msgs__msg__CurrentThreshold));
  bool success = omnihand_node_msgs__msg__CurrentThreshold__init(msg);
  if (!success) {
...
omnihand_node_msgs__msg__CurrentThreshold__Sequence__init(omnihand_node_msgs__msg__CurrentThreshold__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  omnihand_node_msgs__msg__CurrentThreshold * data = NULL;

  if (size) {
    data = (omnihand_node_msgs__msg__CurrentThreshold *)allocator.zero_allocate(size, sizeof(omnihand_node_msgs__msg__CurrentThreshold), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = omnihand_node_msgs__msg__CurrentThreshold__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        omnihand_node_msgs__msg__CurrentThreshold__fini(&data[i - 1]);
      }
...
omnihand_node_msgs__msg__CurrentThreshold__Sequence__fini(omnihand_node_msgs__msg__CurrentThreshold__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      omnihand_node_msgs__msg__CurrentThreshold__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  omnihand_node_msgs__msg__CurrentThreshold__Sequence * array = (omnihand_node_msgs__msg__CurrentThreshold__Sequence *)allocator.allocate(sizeof(omnihand_node_msgs__msg__CurrentThreshold__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = omnihand_node_msgs__msg__CurrentThreshold__Sequence__init(array, size);
  if (!success) {
...
omnihand_node_msgs__msg__CurrentThreshold__Sequence__destroy(omnihand_node_msgs__msg__CurrentThreshold__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    omnihand_node_msgs__msg__CurrentThreshold__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
omnihand_node_msgs__msg__CurrentThreshold__Sequence__are_equal(const omnihand_node_msgs__msg__CurrentThreshold__Sequence * lhs, const omnihand_node_msgs__msg__CurrentThreshold__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!omnihand_node_msgs__msg__CurrentThreshold__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  omnihand_node_msgs__msg__CurrentThreshold__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(omnihand_node_msgs__msg__CurrentThreshold);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    omnihand_node_msgs__msg__CurrentThreshold * data =
      (omnihand_node_msgs__msg__CurrentThreshold *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!omnihand_node_msgs__msg__CurrentThreshold__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          omnihand_node_msgs__msg__CurrentThreshold__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!omnihand_node_msgs__msg__CurrentThreshold__copy(
