 ...
 * @FilePath: omnihand_node/include/omnihand_node/hand_node.h
 * @Description:
 *
...
public:
    OmniHandProNode(
      ...
      const std::string & uart_port = "/dev/omnihand_left",
...
private:
    ...
    rclcpp::Publisher < omnihand_node_msgs::msg::CurrentReport >
    ::SharedPtr current_report_publisher_;                                                                // 1HZ
    rclcpp::Publisher < omnihand_node_msgs::msg::CurrentThreshold >
    ::SharedPtr current_threshold_publisher_;                                                             // 1HZ
    rclcpp::Publisher < omnihand_node_msgs::msg::MotorErrorReport >
    ::SharedPtr motor_error_report_publisher_;                                                            // 1HZ
    rclcpp::Publisher < omnihand_node_msgs::msg::TemperatureReport >
    ::SharedPtr temperature_report_publisher_;                                                            // 1HZ
    ...
    rclcpp::Publisher < omnihand_node_msgs::msg::TactileSensor >
    ::SharedPtr tactile_sensor_publisher_;                                                                // 10HZ

    // Subscribers
    rclcpp::Subscription < omnihand_node_msgs::msg::ControlMode >
    ::SharedPtr control_mode_subscriber_;
    rclcpp::Subscription < omnihand_node_msgs::msg::CurrentThreshold >
    ::SharedPtr current_threshold_subscriber_;
    rclcpp::Subscription < omnihand_node_msgs::msg::MixControl >
    ::SharedPtr mix_control_subscriber_;
    ...
    rclcpp::Subscription < omnihand_node_msgs::msg::MotorAngle >
    ::SharedPtr motor_angle_subscriber_;
    ...
    std::unique_ptr < agilink::omnihand::OmniHand2025 > agibot_hand_;
