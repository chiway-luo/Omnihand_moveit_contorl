...
**C++ 类型说明：** **OmniHand 2025 (O10)** 与 **OmniHand Dex UMI** 的工厂方法及 CAN 广播发现中，`hand_device_id` 与 CAN 适配器索引（`canfd_device_id`、`canfd_channel_id`）使用 **`std::uint8_t`**。完整签名见各产品 C++ API 文档。
