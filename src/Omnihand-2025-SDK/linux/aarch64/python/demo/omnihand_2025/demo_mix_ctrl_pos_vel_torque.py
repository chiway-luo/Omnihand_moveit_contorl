...
examples:
  ...
  python demo_mix_ctrl_pos_vel_torque.py -d zlgcan -t right --canfd-device-id 0 --canfd-channel-id 0
  ...
  python demo_mix_ctrl_pos_vel_torque.py -d rs485 --uart-port COM3

  # USB CDC serial (e.g. COM3 or /dev/ttyACM0)
  python demo_mix_ctrl_pos_vel_torque.py -d usb --uart-port COM3
"""

def main():
    parser = argparse.ArgumentParser(
        description='OmniHand 2025 Mix Control Demo (Position + Velocity + Torque)',
        epilog=EXAMPLES,
