...
"""
Monitor joint motor current for OmniHand 2025 (O10).
...
examples:
  # ZLG CANFD, left hand
  python demo_monitor_current.py -d zlgcan -t left --canfd-device-id 0 --canfd-channel-id 0
  ...
  python demo_monitor_current.py -d rs485 --uart-port COM3

  # USB CDC serial (e.g. COM3 or /dev/ttyACM0)
  python demo_monitor_current.py -d usb --uart-port COM3
"""

def main():
    parser = argparse.ArgumentParser(
        description='Monitor current for OmniHand 2025',
        epilog=EXAMPLES,
