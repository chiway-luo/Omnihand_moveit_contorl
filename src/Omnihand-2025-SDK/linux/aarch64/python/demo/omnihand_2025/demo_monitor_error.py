...
"""
Monitor joint motor error reports for OmniHand 2025 (O10).
...
examples:
  # ZLG CANFD, left hand
  python demo_monitor_error.py -d zlgcan -t left --canfd-device-id 0 --canfd-channel-id 0

  # HCAN, device 0 channel 1
  python demo_monitor_error.py -d hcan --canfd-device-id 0 --canfd-channel-id 1

  # SocketCAN (Linux only)
  python demo_monitor_error.py -d socketcan --can-interface can0

  # RS485, specify serial port (e.g. COM3 or /dev/ttyUSB0)
  python demo_monitor_error.py -d rs485 --uart-port COM3

  # USB CDC serial (e.g. COM3 or /dev/ttyACM0)
  python demo_monitor_error.py -d usb --uart-port COM3
"""

def main():
    parser = argparse.ArgumentParser(
        description='Monitor error for OmniHand 2025',
        epilog=EXAMPLES,
