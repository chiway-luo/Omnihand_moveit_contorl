...
"""
Get tactile sensor data (downsampled) for OmniHand 2025 (O10).
...
examples:
  # ZLG CANFD, left hand
  python demo_tactile_sensor.py -d zlgcan -t left --canfd-device-id 0 --canfd-channel-id 0

  # HCAN, device 0 channel 1
  python demo_tactile_sensor.py -d hcan --canfd-device-id 0 --canfd-channel-id 1

  # SocketCAN (Linux only)
  python demo_tactile_sensor.py -d socketcan --can-interface can0

  # RS485, specify serial port (e.g. COM3 or /dev/ttyUSB0)
  python demo_tactile_sensor.py -d rs485 --uart-port COM3

  # USB CDC serial (e.g. COM3 or /dev/ttyACM0)
  python demo_tactile_sensor.py -d usb --uart-port COM3
"""

def main():
    parser = argparse.ArgumentParser(
        description='Get tactile sensor data for OmniHand 2025',
        epilog=EXAMPLES,
