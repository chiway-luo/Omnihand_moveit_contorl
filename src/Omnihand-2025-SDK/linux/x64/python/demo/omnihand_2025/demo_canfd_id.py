...
"""
OmniHand 2025 comprehensive control demo - CANFD communication (via canfd_id)

This demo creates and controls OmniHand 2025 via canfd_id
...
def control_single_hand(hand, hand_name):
    ...
    try:
        ...
        periods = [500] * 10  # 500 ms period; O10 has 10 joints
